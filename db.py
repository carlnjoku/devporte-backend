...
def save_message_hire_notification_hourly(room, message_body, message_type, project_title, payment_type, hourly_rate, weekly_payout, offerId, senderId, recepientId, recepient_avatar, recepient_fname, recepient_lname, recepient_email, sender_fname, sender_lname, sender_email, sender_avatar, sender_type):
    message = messages_collection.insert_one({'_id': str(ObjectId()), 'room':room, 'message_body': message_body, 'message_type':message_type, 'project_title':project_title, 'payment_type':payment_type, 'hourly_rate':hourly_rate, 'weekly_payout':weekly_payout, 'offerId':offerId, 'senderId':senderId, 'created_date':int(time.time()), 'recepientId': recepientId, 'recepient_avatar':recepient_avatar, 'recepient_fname':recepient_fname, 'recepient_lname':recepient_lname, 'recepient_email':recepient_email,
    'sender_fname':sender_fname, 'sender_lname':sender_lname, 'sender_email':sender_email, 'sender_avatar':sender_avatar, 'sender_type':sender_type})
